...
model = dict(
    ...
    pretrained='work_dirs/finetune_split5/latest.pth',
    ...
    keypoint_head=dict(
        ...
        matching_network=dict(
            ...
            mlp_dim=2048),
        superkeypoints=dict(
            checkpoint='work_dirs/finetune_split5/latest.pth',
...
data = dict(
    ...
    train=dict(
        ...
        superkeypoints='work_dirs/baseline_split5/superkeypoints.pth',
        data_cfg=data_cfg,
